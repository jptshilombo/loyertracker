...
public class AffectationService {
    ...
    public AffectationService(AffectationRepository affectations, BienRepository biens,
            GestionnaireRepository gestionnaires, TenantContext tenant) {
    ...
    public AffectationDto creer(Jwt jwt, AffectationRequest requete) {
        ...
        Affectation affectation = new Affectation(UUID.randomUUID(), bailleurId, requete.bienId(),
        ...
        try {
            ...
            throw new ResponseStatusException(HttpStatus.CONFLICT,
                    "Une affectation active existe déjà sur ce bien.");
