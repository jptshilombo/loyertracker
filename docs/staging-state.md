...
> Le **`sha-e4744d92`** (EP-16 Sprint N Fondation notifications, déployé le 2026-07-19) est le
> **tag actif en staging**. Flyway **27/27**, smoke **63/0**, STG-ISOL-01 PASS avant/après,
> 24 événements métier et 0 Outbox/Delivery sans consentement. Aucun credential ou appel Twilio.
