...
> Le **`sha-75646d8f`** (Sprint 12 EP-14b, déployé le 2026-07-06) est le **tag actif en staging**.
> Flyway **22/22**, smoke **62/0**, STG-ISOL-01 PASS avant/après. Vérification publique réelle
> `QT-2026-000001` VALIDE, PDF intègre, métriques et rate-limit 429 confirmés. La release EP-14 est
> désormais complète en Staging ; la Production reste soumise au Gate distinct `1.9.0`.
>
