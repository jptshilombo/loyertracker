...
> Le **`sha-c9200a51`** (Sprints A+B EP-15, déployé le 2026-07-15) est le **tag actif en staging**.
> Flyway **24/24**, smoke **62/0** + vérification manuelle dédiée **48/0**, STG-ISOL-01 PASS
> avant/après. Cycle de vie Gestionnaire (statut global, suspension/réactivation, archivage
> cross-tenant conditionné) et entité Locataire (RLS standard, CRUD, cycle de vie) confirmés en
> conditions réelles, y compris les deux correctifs du PR #209. La Production reste soumise à un
> Gate distinct (Sprints A+B combinés, aucune promotion isolée du Sprint A).
>
