...
> Le **`sha-2c5f43c7`** (Sprint 10 EP-12b US-95/96/97 + correctif RSV-S10-01, déployé le
> 2026-07-04 à ~15:40 UTC par arbitrage PO S1) est le **tag actif en staging**, avec exposition
> publique active sur `https://loyertracker.staging.loyerpro.org`. Flyway **21/21** (inchangé —
> le correctif ne porte aucune migration). Smoke **59/0** au premier passage. STG-ISOL-01 PASS
