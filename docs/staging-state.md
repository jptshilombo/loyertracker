...
| `LOYERTRACKER_TAG` | **déployé : `sha-359f4d63`** (Sprint C EP-15 Bascule Bail → Locataire, US-113/114, PR #229, déployé le 2026-07-17, STG-ISOL-01 PASS avant/après, Flyway V26 26/26, backfill 35/35 vérifié, smoke 63/0 au 1er passage — `docs/cgpa/07-devsecops/gate-staging-sprint-c-ep15-decision.md`) |
...
> Le **`sha-cba13f52`** (Sprint unique EP-13 Fin de bail, déployé le 2026-07-16) est le **tag actif
> en staging**. Flyway **25/25**, smoke **62/0** + vérification manuelle dédiée **22/0**,
